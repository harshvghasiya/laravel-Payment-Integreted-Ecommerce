...
<body class="ecommerce">
    ...
    <div class="header">
      <div class="container">
        <a class="site-logo" href="shop-index.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/layout/img/logos/logo-shop-red.png" alt="Metronic Shop UI"></a>
          ...
          <div class="top-cart-content-wrapper">
            <div class="top-cart-content">
              <ul class="scroller" style="height: 250px;">
                <li>
                  <a href="shop-item.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/cart-img.jpg" alt="Rolex Classic Watch" width="37" height="34"></a>
                  ...
                  <div class="header-navigation-content">
                    <div class="row">
                      ...
                      <div class="col-md-12 nav-brands">
                        <ul>
                          <li><a href="shop-product-list.html"><img title="esprit" alt="esprit" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/brands/esprit.jpg"></a></li>
                          <li><a href="shop-product-list.html"><img title="gap" alt="gap" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/brands/gap.jpg"></a></li>
                          <li><a href="shop-product-list.html"><img title="next" alt="next" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/brands/next.jpg"></a></li>
                          <li><a href="shop-product-list.html"><img title="puma" alt="puma" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/brands/puma.jpg"></a></li>
                          <li><a href="shop-product-list.html"><img title="zara" alt="zara" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/brands/zara.jpg"></a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="header-navigation-content">
                    <div class="row">
                      <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <a href="shop-item.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/model4.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                          </div>
                      ...
                      <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <a href="shop-item.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/model3.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                          </div>
                          <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                          <div class="pi-price">$29.00</div>
                          <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                      ...
                      <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <a href="shop-item.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/model7.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                          </div>
                          <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                          <div class="pi-price">$29.00</div>
                          <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="sidebar col-md-3 col-sm-5">
            ...
            <div class="sidebar-products clearfix">
              <h2>Bestsellers</h2>
              <div class="item">
                <a href="shop-item.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/k1.jpg" alt="Some Shoes in Animal with Cut Out"></a>
                <h3><a href="shop-item.html">Some Shoes in Animal with Cut Out</a></h3>
                <div class="price">$31.00</div>
              </div>
              <div class="item">
                <a href="shop-item.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/k4.jpg" alt="Some Shoes in Animal with Cut Out"></a>
                <h3><a href="shop-item.html">Some Shoes in Animal with Cut Out</a></h3>
                <div class="price">$23.00</div>
              </div>
              <div class="item">
                <a href="shop-item.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/k3.jpg" alt="Some Shoes in Animal with Cut Out"></a>
                <h3><a href="shop-item.html">Some Shoes in Animal with Cut Out</a></h3>
              ...
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/model7.jpg" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/model7.jpg">
                  </div>
                  <div class="product-other-images">
                    <a href="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/model3.jpg" class="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/model3.jpg"></a>
                    <a href="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/model4.jpg" class="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/model4.jpg"></a>
                    <a href="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/model5.jpg" class="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/model5.jpg"></a>
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
          ...
          <div class="col-md-12 col-sm-12">
            ...
            <div class="owl-carousel owl-carousel4">
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/k1.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/k1.jpg" class="btn btn-default fancybox-button">Zoom</a>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/k2.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/k2.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/k3.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/k3.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/k4.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/products/k4.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
    ...
    <div class="brands">
      <div class="container">
            <div class="owl-carousel owl-carousel6-brands">
              <a href="shop-product-list.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/brands/canon.jpg" alt="canon" title="canon"></a>
              <a href="shop-product-list.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/brands/esprit.jpg" alt="esprit" title="esprit"></a>
              <a href="shop-product-list.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/brands/gap.jpg" alt="gap" title="gap"></a>
              <a href="shop-product-list.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/brands/next.jpg" alt="next" title="next"></a>
              <a href="shop-product-list.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/brands/puma.jpg" alt="puma" title="puma"></a>
              <a href="shop-product-list.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/brands/zara.jpg" alt="zara" title="zara"></a>
              <a href="shop-product-list.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/brands/canon.jpg" alt="canon" title="canon"></a>
              <a href="shop-product-list.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/brands/esprit.jpg" alt="esprit" title="esprit"></a>
              <a href="shop-product-list.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/brands/gap.jpg" alt="gap" title="gap"></a>
              <a href="shop-product-list.html"><img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/assets/frontend/pages/img/brands/next.jpg" alt="next" title="next"></a>
