...
<ul class="page-breadcrumb breadcrumb">
  ...
  <li>
    <a href="{{route('admin.sub_category.index')}}">{{trans('lang_data.sub_category_list_label')}}</a><i class="fa fa-circle"></i>
  </li>
  <li class="active">
    @if(isset($category))
      {{trans('lang_data.edit_sub_category_label')}}
    @else
      {{trans('lang_data.add_sub_category_label')}}
    @endif
  </li>
</ul>
<div class="row">
          ...
          <div class="" id="tab_2">
            <div class="portlet box green">
              ...
              <div class="portlet-body form">
                  ...
                  @endif
                  <div class="form-body">
                    <h3 class="form-section">{{trans('lang_data.sub_category_info_label')}}</h3>
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            {{ Form::select('category_id',[''=>'Select category']+\App\Models\Category::getCatDropDown(),null,['id'=>'category_id','class'=>'form-control'])}}
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="row">
                          <div class="col-md-offset-3 col-md-9">
                            ...
                            <a href="{{route('admin.sub_category.index')}}" type="button" class="btn default">{{trans('lang_data.cancel_label')}}</a>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
