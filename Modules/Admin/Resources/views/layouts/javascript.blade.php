<script src='{{UPLOAD_AND_DOWNLOAD_URL()}}public/admin/mix/js/all.js'></script>
<script src="{{ UPLOAD_AND_DOWNLOAD_URL()}}public/admin/js/tinymce/jquery.tinymce.min.js"></script>	
<script src="{{ UPLOAD_AND_DOWNLOAD_URL()}}public/admin/js/tinymce/tinymce.min.js"></script>
<script src='{{UPLOAD_AND_DOWNLOAD_URL()}}public/admin/comman_js/common.js'></script>
<script src="https://cdn.jsdelivr.net/jquery.validation/1.16.0/additional-methods.min.js"></script>
<script src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/validation/jquery.validate.js"></script>
<script>
...
tinymce.init({
		...
		images_upload_url : "{{route('admin.save_tinymce_image')}}",
		...
		images_upload_handler : function(blobInfo, success, failure) {
			...
			xhr.open('POST', "{{route('admin.save_tinymce_image')}}",true);
