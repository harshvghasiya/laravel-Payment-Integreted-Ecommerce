                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            ...
                            {{ Form::select('parent_id',[''=>trans('lang_data.select_parent_page_label')]+ \App\Models\Cms::getCmsDropDown(),null,['id'=>'',"class"=>"form-control"])
                            }}
                          </div>
                        </div>
                      </div>
                       <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            ...
                            ?>
                            {{ Form::select('module_id[]',[''=>trans('lang_data.select_module_type_label')]+ \App\Models\Module::getModuleDropDown(),$moduleArray,['multiple'=>true,'id'=>'',"class"=>"form-control"])
                            }}
                        </div>
                        </div>
                      </div>
                     ...
                     <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            {{ Form::text('redirect_url',null,['placeholder'=>'Redirect URL','id'=>'redirect_url','class'=>'form-control']) }}
                        </div>
                        </div>
                      </div>
                      <div class="col-md-6">
