...
<ul class="page-breadcrumb breadcrumb">
  ...
  <li>
    <a href="{{route('admin.category.index')}}">{{trans('lang_data.banner_listing_label')}}</a><i class="fa fa-circle"></i>
  </li>
  <li class="active">
    @if(isset($category))
          ...
          <div class="" id="tab_2">
            <div class="portlet box green">
              ...
              <div class="portlet-body form">
                  ...
                  @endif
                  <div class="form-body">
                    <h3 class="form-section">{{trans('lang_data.banner_category_label')}}</h3>
                    <div class="row">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label col-md-3">{{trans('lang_data.featured_cateogry_label')}}</label>
                          <div class="col-md-9">
                            <div class="radio-list">
                              <label class="radio-inline">
                              <input type="checkbox" name="is_featured" value="1" {{ isset($category)?($category->is_featured == 1)?'checked':'':'' }} />
