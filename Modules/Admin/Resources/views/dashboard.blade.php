					...
					<div class="portlet light ">
						...
						<div class="portlet-body">
							...
							<div class="table-scrollable table-scrollable-borderless">
								...
								<tr>
									<td class="fit">
										<img class="user-pic" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/admin/admin/layout4/img/avatar4.jpg">
									</td>
									<td>
								...
								<tr>
									<td class="fit">
										<img class="user-pic" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/admin/admin/layout4/img/avatar5.jpg">
									</td>
									<td>
								...
								<tr>
									<td class="fit">
										<img class="user-pic" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/admin/admin/layout4/img/avatar6.jpg">
									</td>
									<td>
								...
								<tr>
									<td class="fit">
										<img class="user-pic" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/admin/admin/layout4/img/avatar7.jpg">
									</td>
									<td>
							...
							<div class="scroller" style="height: 305px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
								<div class="general-item-list">
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/admin/admin/layout4/img/avatar4.jpg">
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/admin/admin/layout4/img/avatar3.jpg">
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/admin/admin/layout4/img/avatar6.jpg">
												<a href="" class="item-name primary-link">Nick Larson</a>
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/admin/admin/layout4/img/avatar7.jpg">
												<a href="" class="item-name primary-link">Nick Larson</a>
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/admin/admin/layout4/img/avatar9.jpg">
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/admin/admin/layout4/img/avatar8.jpg">
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/admin/admin/layout4/img/avatar2.jpg">
...
{{-- <div class="row margin-top-10">
		...
		<div class="dashboard-stat2">
			<a href="{{route('admin.contactus.index')}}">
				<div class="display">
					<div class="number">
						<div class="icon">
							<i class="fa fa-phone-square" aria-hidden="true"></i> <small>{{trans('lang_data.request_required')}}</small>
						</div>
					</div>
				</div>
			</a>
		...
		<div class="dashboard-stat2">
			<a href="{{route('admin.sub_category.index')}}">
				<div class="display">
					<div class="number">
						<div class="icon">
							<i class="fa fa-tag" aria-hidden="true"></i> <small>{{trans('lang_data.sub_category_label')}}</small>
						</div>
					</div>
				</div>
			</a>	
		...
		<div class="dashboard-stat2">
			<a href="{{route('admin.product.index')}}">
				<div class="display">
					<div class="number">
						<div class="icon">
							<i class="fa fa-list-alt" aria-hidden="true"></i> <small>{{trans('lang_data.product_label')}}</small>
						</div>
					</div>
				</div>
			</a>	
		...
		<div class="dashboard-stat2">
			<a href="{{route('admin.brand.index')}}">
				<div class="display">
					<div class="number">
						<div class="icon">
							<i class="fa fa-btc" aria-hidden="true"></i> <small>{{trans('lang_data.brand_label')}}</small>
						</div>
					</div>
				</div>
			</a>	
	...
	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
		<div class="dashboard-stat2">
			<a href="{{route('admin.right.index')}}">
				<div class="display">
					<div class="number">
						<div class="icon">
							<i class="fa fa-tasks" aria-hidden="true"></i> <small>{{trans('lang_data.right')}}</small>
						</div>
					</div>
				</div>
			</a>	
		...
		<div class="dashboard-stat2">
			<a href="{{route('admin.admin_user.index')}}">
				<div class="display">
					<div class="number">
						<div class="icon">
							<i class="fa fa-users" aria-hidden="true"></i> <small>{{trans('lang_data.admin_user')}}</small>
						</div>
					</div>
				</div>
			</a>	
