<div class="page-sidebar-wrapper">
	<div class="page-sidebar navbar-collapse collapse">
		<ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">	
			...
			<?php if( CHECK_RIGHTS_TO_ACCESS(App\Models\Acl::CONST_CATEGORY_MODULE) || CHECK_RIGHTS_TO_ACCESS(App\Models\Acl::CONST_SUB_CATEGORY_MODULE)): ?>
			<li <?php echo e($commonModule); ?>>
				<a href="javascript:;">
				...
				<ul class="sub-menu" style="display: <?php echo e($commonModuleBlock); ?>;">
					...
					<li <?php if(\Request()->route()->getName() == 'admin.sub_category.index' || \Request()->route()->getName() == 'admin.sub_category.create' || \Request()->route()->getName() == 'admin.sub_category.edit'): ?>  class="active"  <?php endif; ?>><a href="<?php echo e(route('admin.sub_category.index')); ?>"><i class="icon-handbag"></i> <?php echo e(trans('lang_data.sub_category_label')); ?></a></li>
					<?php endif; ?>
				</ul>
			</li>
			<?php endif; ?>
			...
			<?php if( CHECK_RIGHTS_TO_ACCESS(App\Models\Acl::CONST_COUNTRY_MODULE)): ?>
			<li <?php echo e($commonModule); ?>>
				<a href="javascript:;">
				<i class="fa fa-map-marker" aria-hidden="true"></i>
				<span class="title"><?php echo e(trans('lang_data.location_management_keyword')); ?></span>
				<span class="arrow "></span>
				</a>
				<ul class="sub-menu" style="display: <?php echo e($commonModuleBlock); ?>;">
					<?php if(CHECK_RIGHTS_TO_ACCESS(App\Models\Acl::CONST_COUNTRY_MODULE)): ?>
					<li <?php if(\Request()->route()->getName() == 'admin.country.index' || \Request()->route()->getName() == 'admin.country.create' || \Request()->route()->getName() == 'admin.country.edit'): ?>  class="active"  <?php endif; ?>><a href="<?php echo e(route('admin.country.index')); ?>"><i class="fa fa-map-marker"></i> <?php echo e(trans('lang_data.country_label')); ?></a></li>
					<?php endif; ?>
				</ul>
			</li>
			<?php endif; ?>
			...
			<?php if( CHECK_RIGHTS_TO_ACCESS(App\Models\Acl::CONST_PRODUCT_MODULE) || CHECK_RIGHTS_TO_ACCESS(App\Models\Acl::CONST_BRAND_MODULE)): ?>
			<li <?php echo e($commonModule); ?>>
				<a href="javascript:;">
				<i class="fa fa-list-alt" aria-hidden="true"></i>
				<span class="title"><?php echo e(trans('lang_data.product_management_label')); ?></span>
				<span class="arrow "></span>
				</a>
				<ul class="sub-menu" style="display: <?php echo e($commonModuleBlock); ?>;">
					<?php if(CHECK_RIGHTS_TO_ACCESS(App\Models\Acl::CONST_PRODUCT_MODULE)): ?>
					<li <?php if(\Request()->route()->getName() == 'admin.product.index' || \Request()->route()->getName() == 'admin.product.create' || \Request()->route()->getName() == 'admin.product.edit'): ?>  class="active"  <?php endif; ?>><a href="<?php echo e(route('admin.product.index')); ?>"><i class="icon-handbag"></i> <?php echo e(trans('lang_data.product_label')); ?></a></li>
					<?php endif; ?>
					<?php if(CHECK_RIGHTS_TO_ACCESS(App\Models\Acl::CONST_BRAND_MODULE)): ?>
					<li <?php if(\Request()->route()->getName() == 'admin.brand.index' || \Request()->route()->getName() == 'admin.brand.create' || \Request()->route()->getName() == 'admin.brand.edit'): ?>  class="active"  <?php endif; ?>><a href="<?php echo e(route('admin.brand.index')); ?>"><i class="icon-handbag"></i> <?php echo e(trans('lang_data.brand_label')); ?></a></li>
					<?php endif; ?>
				</ul>
			</li>
			<?php endif; ?>
...
<?php /**PATH E:\laragon\www\amit_ecom\Modules/Admin\Resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>