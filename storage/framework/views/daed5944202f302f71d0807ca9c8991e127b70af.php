              ...
              <div class="portlet-body form">
                  ...
                  <div class="form-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label col-md-3"><?php echo e(trans('lang_data.featured_cateogry_label')); ?></label>
                          <div class="col-md-9">
                            <div class="radio-list">
                              <label class="radio-inline">
                              <input type="checkbox" name="is_featured" value="1" <?php echo e(isset($category)?($category->is_featured == 1)?'checked':'':''); ?> />
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\amit_ecom\Modules/Admin\Resources/views/category/addedit.blade.php ENDPATH**/ ?>