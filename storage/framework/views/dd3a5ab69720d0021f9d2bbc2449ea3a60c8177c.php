...
<ul class="page-breadcrumb breadcrumb">
  ...
  <li class="active">
     <?php echo e(trans('lang_data.category_list_label')); ?>
  ...
  <div class="col-md-12">
            ...
            <!-- form-inline -->
              <form method="POST" id="search-form" class="" role="form">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                        <label for="name"><?php echo e(trans('lang_data.show_on_header_label')); ?></label>
                        <select name="show_on_header" class="form-control">
                          <option value=""><?php echo e(trans('lang_data.select_header_status_label')); ?></option>
                          <option value="1"><?php echo e(trans('lang_data.yes_label')); ?></option>
                          <option value="0"><?php echo e(trans('lang_data.no_label')); ?></option>
                        </select>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                        <label for="name"><?php echo e(trans('lang_data.show_on_footer_label')); ?></label>
                        <select name="show_on_footer" class="form-control">
                          <option value=""><?php echo e(trans('lang_data.select_footer_status_label')); ?></option>
                          <option value="1"><?php echo e(trans('lang_data.yes_label')); ?></option>
                          <option value="0"><?php echo e(trans('lang_data.no_label')); ?></option>
                        </select>
                    </div>
    ...
    <div class="portlet box grey-cascade">
      <div class="portlet-title">
        <div class="caption">
          <i class="fa fa-globe"></i><?php echo e(trans('lang_data.managed_category_label')); ?>
      ...
      <div class="portlet-body">
        <div class="table-toolbar">
          <div class="row">
            <div class="col-md-6">
              <div class="btn-group">
                <a href="<?php echo e(route('admin.category.create')); ?>" id="sample_editable_1_new" class="btn green">
                <?php echo e(trans('lang_data.add_new_label')); ?> <i class="fa fa-plus"></i>
                </a>
              </div>
              <?php if(env('ACCESS_TO_DELETE') == true): ?>
              <div class="btn-group">
                <a class="btn btn-danger" onclick="deleteAll('table_form','<?php echo e(route('admin.category.delete_all')); ?>')"><?php echo e(trans('lang_data.delete_all_label')); ?>

                </a>
              </div>
              <?php endif; ?>
              <div class="btn-group">
                <a class="btn btn-warning" onclick="statusAll('table_form','<?php echo e(route('admin.category.status_all')); ?>')"><?php echo e(trans('lang_data.status_all_label')); ?>
...
<script>
  var oTable = $('#users-table').DataTable({
      ...
      responsive: true,
      ajax: {
            url:'<?php echo route('admin.category.any_data'); ?>',
            data: function (d) {
              d.name = $('input[name=name]').val();
              d.status = $('select[name=status]').val();
              d.show_on_header = $('select[name=show_on_header]').val();
              d.show_on_footer = $('select[name=show_on_footer]').val();
            }
          },
      columns: [
    ...
    $(document).on("click","#active_inactive",function(){
      ...
      .then((willDelete) => {
        if (willDelete) {
              ...
              $.ajax({
                type:"POST",
                url:"<?php echo e(route('admin.category.single_status_change')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\amit_ecom\Modules/Admin\Resources/views/category/index.blade.php ENDPATH**/ ?>