...
<title><?php echo e($emailTemplate->title); ?></title>
<?php else: ?>
<title><?php echo e(trans('lang_data.app_name')); ?></title>
<?php endif; ?>
<style type="text/css">
        body {
            margin: 0;
...
<img align="center" alt="<?php echo e(trans('lang_data.app_name')); ?>" border="0" class="center fixedwidth" 
src="<?php echo e($setting->getSettingLogoImageUrl()); ?>" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 150px; display: block;" title="<?php echo e(trans('lang_data.app_name')); ?>" width="352"/>
</div>
<?php
...
<?php if(isset($socialMediaContent) && !empty($socialMediaContent)): ?>
...
<?php $__currentLoopData = $socialMediaContent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 5px; padding-left: 5px;" valign="top">
        <a href="<?php echo e($v->url); ?>" target="_blank"><img alt="<?php echo e($v->title); ?>" height="32" src="<?php echo e($v->getSocialMediaImageUrl()); ?>" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; display: block;" title="<?php echo e($v->title); ?>" width="32"/>
        </a>
    </td>
...
<p style="font-size: 12px; line-height: 1.2; word-break: break-word; text-align: left; font-family: inherit; mso-line-height-alt: 14px; margin: 0;"><span style="color: #95979c; font-size: 12px;"><?php echo e(trans('lang_data.app_name')); ?> Copyright © <?php echo e(date('Y')); ?></span></p>
</div>
</div>
</div>
</div>
...
</html><?php /**PATH E:\laragon\www\amit_ecom\resources\views/emails/mail_template.blade.php ENDPATH**/ ?>