...
<ul class="page-breadcrumb breadcrumb">
  ...
  <li>
    <a href="<?php echo e(route('admin.sub_category.index')); ?>"><?php echo e(trans('lang_data.sub_category_list_label')); ?></a><i class="fa fa-circle"></i>
  </li>
  <li class="active">
    <?php if(isset($category)): ?>
      <?php echo e(trans('lang_data.edit_sub_category_label')); ?>

    <?php else: ?>
      <?php echo e(trans('lang_data.add_sub_category_label')); ?>
              ...
              <div class="portlet-body form">
                  <?php if(isset($category)): ?>
                    <?php echo e(Form::model($category,
                      ...
                      'data-redirect_url' => route('admin.sub_category.index'),
                      'url'               => route('admin.sub_category.update', $encryptedId),
                      'method'            => 'PUT',
                  ...
                  <?php endif; ?>
                  <div class="form-body">
                    <h3 class="form-section"><?php echo e(trans('lang_data.sub_category_info_label')); ?></h3>
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <?php echo e(Form::select('category_id',[''=>'Select category']+\App\Models\Category::getCatDropDown(),null,['id'=>'category_id','class'=>'form-control'])); ?>
                      ...
                      <div class="col-md-6">
                        <div class="row">
                          <div class="col-md-offset-3 col-md-9">
                            ...
                            <a href="<?php echo e(route('admin.sub_category.index')); ?>" type="button" class="btn default"><?php echo e(trans('lang_data.cancel_label')); ?></a>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\amit_ecom\Modules/Admin\Resources/views/sub_category/addedit.blade.php ENDPATH**/ ?>