	                  ...
	                  <div class="panel-body row">
	                    <div class="col-md-6 col-sm-6">
	                      <div class="form-group">
	                        ...
	                        <input type="text" name="name" value="<?php echo e(Auth::guard('user_login')->user()->name); ?>" id="firstname-dd" class="form-control">
	                      </div>
	                      <div class="form-group">
	                        <label for="email-dd">E-Mail <span class="require">*</span></label>
	                        <input type="text" name="email" value="<?php echo e(Auth::guard('user_login')->user()->email); ?>" id="email-dd" class="form-control">
	                      </div>
	                      <div class="form-group">
	                        <label for="telephone-dd">Mobile <span class="require">*</span></label>
	                        <input type="text" name="mobile" value="<?php echo e(Auth::guard('user_login')->user()->mobile); ?>" id="mobile-dd" class="form-control">
	                      </div>
	                  ...
	                  <div class="panel-body row">
	                    <div class="col-md-12 clearfix">
	                      ...
	                      <table>
	                        ...
	                        <?php $total=0;?>
	                        <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                        <?php
	                          $total=($result->quantity)*$result->product->price+$total; 
	                        ?>
	                            <input type="hidden" name="product_id[]" value="<?php echo e(Crypt::encrypt($result->product->id)); ?>">
		                        <tr>
		                          ...
		                          <td class="checkout-quantity"><?php echo e($result->quantity); ?></td>
		                          <td class="checkout-price"><strong><span>Rs.</span><?php echo e($result->product->price); ?></strong></td>
		                          <td class="checkout-total"><strong><span>Rs.</span><?php echo e($result->product->price*$result->quantity); ?></strong></td>
		                        </tr>
	                      ...
	                      <div class="checkout-total-block">
	                        <ul>
	                         <input type="hidden" name="amount" value="<?php echo e(Crypt::encrypt($total)); ?>">
	                          <li class="checkout-total-price">
	                            <em>Total</em>
	                            <strong class="price"><span>Rs.</span><?php echo e($total); ?></strong>
	                          </li>
	                        </ul>
	                      </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\amit_ecom\resources\views/front/cart/checkout.blade.php ENDPATH**/ ?>