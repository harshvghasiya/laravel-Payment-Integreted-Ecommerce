  ...
  public function blogAjax($request){
    ...
    $routeDemo = false;
        ...
        if ($checkRequest) {
          ...
          return view('front.home.pagination_latest_blog',compact("blogList","searchKeyword","routeDemo"))->render();
    ...
    public function getBlogDetailsFront($slug){
        ...
        if ($checkRequest) {
          ...
          return view('front.category.blog.blog_detail',compact("getBlogDetail","allCategory","title"));
