                    		...
                    		->addColumn('action',function($data){
                                ...
                                $string ='<a href="'.route('admin.modules.edit',Crypt::encrypt($data->id)).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>';
                                  ...
                                  if (env('ACCESS_TO_DELETE') == true) {
                                    ...
                                    $string1 .='<a href="javascript:void(0)" data-route="'.route('admin.modules.destroy',Crypt::encrypt($data->id)).'" class="btn btn-xs btn-danger delete_record"><i class="fa fa-trash" aria-hidden="true"></i></a>';
                                  }
